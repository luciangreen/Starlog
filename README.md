...
Stage 5 rule: named structural labels (for example diagonal/row/column style labels) are not treated as dedicated optimisation classes. They are handled through the same general first-principles symbolic tracing and relation reconstruction pipeline.
